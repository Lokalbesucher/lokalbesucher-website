...
(function () {
  ...
  function createBanner() {
    ...
    d.innerHTML = [
      ...
      '#lb-btn-accept{font-family:var(--font-head,Arial,Helvetica,sans-serif);font-weight:700;font-size:.875rem;',
      ...
      '#lb-btn-decline{font-family:var(--font-head,Arial,Helvetica,sans-serif);font-weight:700;font-size:.875rem;',
