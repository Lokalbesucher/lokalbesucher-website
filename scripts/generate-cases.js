...
.filter-btn{background:#111328;border:1px solid #1e2240;border-radius:8px;padding:.5em 1.1em;font-family:'DM Sans',system-ui,sans-serif;font-size:.8rem;font-weight:700;color:#6b7099;cursor:pointer;transition:all .2s}
...
.case-num{font-family:'DM Sans',system-ui,sans-serif;font-size:2.25rem;font-weight:800;color:#ffbd59;line-height:1}
.case-metric{font-size:.8rem;color:#6b7099;margin-top:.2rem}
.case-name{font-size:1.05rem;font-weight:700;color:#e8eaf6;margin-top:1rem;font-family:'DM Sans',system-ui,sans-serif}
.case-cat{font-size:.8rem;color:#6b7099;margin-top:.25rem}
.case-cta{display:inline-flex;align-items:center;gap:.35rem;font-size:.85rem;font-weight:700;color:#ffbd59;text-decoration:none;margin-top:1.25rem;font-family:'DM Sans',system-ui,sans-serif}`;
